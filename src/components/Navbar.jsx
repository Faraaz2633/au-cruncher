        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center py-6 lg:justify-start md:space-x-10">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <Link to="/">
                <span className=" text-xl font-medium md:text-2xl lg:text-3xl text-white">
                  AU Cruncher
                </span>
              </Link>
            </div>
            ...
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-[#1a202b] divide-y-2 divide-gray-50">
              <div className="pt-5 pb-6 px-5">
                <div className="flex items-center justify-between bg-[#1a2234] p-3 rounded-lg">
                  <div className="text-xl font-medium md:text-2xl text-white">
                    {" "}
                    AU Cruncher
                  </div>
                ...
                <div className="mt-6">
                  <nav className="grid gap-y-8 px-3">
                    <Link
                      to="/"
                      onClick={handleNav}
                      className="-m-3 p-3 flex items-center rounded-md hover:bg-[#252e43]"
                    >
                    ...
                    {navData.map((data) => (
                      ...
                      >
                        ...
                        <span className="ml-2 pl-2 text-base font-medium text-white">
                          {data.name}
                        </span>
                      </Link>
                    ))}
