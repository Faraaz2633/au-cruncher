                ...
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className=" block w-auto" id="mobile-menu">
                        <ul className="flex  flex-row space-x-8 mt-0 text-lg font-medium">
                            <li>
                                <a href="https://www.mdfaraz.tech/" target="_blank" rel="noreferrer" className="block  text-white rounded bg-transparent p-0 hover:text-[#E0CCFF]" aria-current="page">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
