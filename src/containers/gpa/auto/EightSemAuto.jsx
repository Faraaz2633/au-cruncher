...
const EightSemAuto = () => {
  ...
  const [sub4Credit, setSub4Credit] = useState(10);
  ...
  const calculateResult = () => {
      const totalCredit = sub1Credit + sub2Credit + sub3Credit + sub4Credit;
      const totalPoints = sub1 + sub2 + sub3 + sub4;
  ...
  return (
      <div className="m-5 pt-4 text-center">
          <h1 className="font-bold text-2xl pt-2">Auto Mobile - 8th Semester</h1>
          <div>
