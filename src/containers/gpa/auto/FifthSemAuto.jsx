...
const FifthSemAuto = () => {
  ...
  return (
      <div className="m-5 pt-4 text-center">
          <h1 className="font-bold text-2xl pt-2">Auto Mobile - 5th Semester</h1>
          <div>
              ...
              <Subject
                  name="Automotive Electrical and Electronics Systems"
                  credit={sub3Credit}
              ...
              <Subject
                  name="Vehicle Design Data Characteristics"
                  credit={sub4Credit}
              ...
              <Subject
                  name="Automotive Electrical and Electronics Laboratory"
                  credit={sub7Credit}
              ...
              <Subject
                  name="Automotive Fuels and Lubricants Laboratory"
                  credit={sub8Credit}
