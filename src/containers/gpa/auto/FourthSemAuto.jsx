...
const FourthSemAuto = () => {
  ...
  return (
      <div className="m-5 pt-4 text-center">
          <h1 className="font-bold text-2xl pt-2">Auto Mobile - 4th Semester</h1>
          <div>
              <h1 className="text-2xl font-bold pt-2">Theory</h1>
              <Subject
                  name="Static and Numarical Methods"
                  credit={sub1Credit}
              ...
              <Subject
                  name="Compression Ignition Engines"
                  credit={sub2Credit}
              ...
              <Subject
                  name="Electronics and Microprocessors "
                  credit={sub4Credit}
              ...
              <Subject
                  name="Automotive components Laboratory"
                  credit={sub7Credit}
              ...
              <Subject
                  name="Electronics and Microprocessors Laboratory"
                  credit={sub8Credit}
