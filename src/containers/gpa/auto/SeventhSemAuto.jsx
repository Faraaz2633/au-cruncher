...
const SeventhSemAuto = () => {
  ...
  return (
      <div className="m-5 pt-4 text-center">
          <h1 className="font-bold text-2xl pt-2">Auto Mobile - 7th Semester</h1>
          <div>
              <h1 className="text-2xl font-bold pt-2">Theory</h1>
              <Subject
                  name="Engine and Vehicle Management System"
                  credit={sub1Credit}
              ...
              <Subject
                  name="Engine Performance and Emission Testing Laboratory"
                  credit={sub7Credit}
              ...
              <Subject
                  name="Vehicle Maintenance Laboratory"
                  credit={sub8Credit}
