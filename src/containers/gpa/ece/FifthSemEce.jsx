...
const FifthSemEce = () => {
  ...
  const [sub9Credit, setSub9Credit] = useState(2);
  ...
  return (
    <div className="m-5 text-center">
      <h1 className="font-bold text-2xl pt-2">ECE - 5th Semester</h1>
      <div>
        ...
        <Subject
          name="Computer Architecture and
          Organization"
          credit={sub3Credit}
