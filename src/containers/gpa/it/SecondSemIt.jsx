...
const SecondSemIt = () => {
    ...
    const calculateResult = () => {
        ...
        setGlobalResult((totalPoints / totalCredit).toFixed(2))
    }
    ...
    return (
        <div className="m-5 text-center">
            <h1 className="font-bold text-2xl pt-2">IT - 2nd Semester</h1>
            <div>
                ...
                <Subject
                    name="Information Technology Essentials Laboratory"
                    credit={sub9Credit}
