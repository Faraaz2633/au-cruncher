  ...
  const data = [
    {
      ...
      units:[
        ...
        },
        {
          ...
          content: 'Definite and Indefinite integrals — Substitution rule — Techniques of Integration — Integration by parts, Trigonometric integrals, Trigonometric substitutions, Integration of rational functions by partial fraction, Integration of irrational functions — Improper integrals.'
        },
        {
          chapterName: 'Unit 4 - MULTIPLE INTEGRALS',
          content: 'Double integrals — Change of order of integration — Double integrals in polar coordinates — Area enclosed by plane curves — Triple integrals — Volume of solids — Change of variables in double and triple integrals.'
        },
        {
          chapterName: 'Unit 5 - DIFFERENTIAL EQUATIONS',
          content: 'Higher order linear differential equations with constant coefficients — Method of variation of parameters — Homogenous equation of Euler?s and Legendre?s type — System of simultaneous linear differential equations with constant coefficients — Method of undetermined coefficients.'
        }
      ],
      links:[
        {
      ...
      units:[
        {
          ...
          content: 'Algorithms, building blocks of algorithms (statements, state, control flow, functions), notation (pseudo code, flow chart, programming language), algorithmic problem solving, simple strategies for developing algorithms (iteration, recursion). Illustrative problems: find minimum in a list, insert a card in a list of sorted cards, guess an integer number in a range, Towers of Hanoi.'
        },
        {
        ...
        },
        {
          ...
          content: 'Conditionals: Boolean values and operators, conditional (if), alternative (if-else), chained conditional (if-elif-else); Iteration: state, while, for, break, continue, pass; Fruitful functions: return values, parameters, local and global scope, function composition, recursion; Strings: string slices,immutability, string functions and methods, string module; Lists as arrays. Illustrative programs: square root, gcd, exponentiation, sum an array of numbers, linear search, binary search.'
        },
        {
          chapterName: 'Unit 4 - LISTS, TUPLES, DICTIONARIES ',
          content: 'Lists: list operations, list slices, list methods, list loop, mutability, aliasing, cloning lists, list parameters; Tuples: tuple assignment, tuple as return value; Dictionaries: operations and methods; advanced list processing — list comprehension; Illustrative programs: selection sort, insertion sort, mergesort, histogram.'
        },
        {
          chapterName: 'Unit 5 - FILES, MODULES, PACKAGES',
          content: 'Files and exception: text files, reading and writing files, format operator; command line arguments, errors and exceptions, handling exceptions, modules, packages; Illustrative programs: word count, copy file.'
        }
