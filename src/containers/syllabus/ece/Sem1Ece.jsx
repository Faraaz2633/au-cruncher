...
const Sem1Ece = () => {
      ...
      subjectName: ' HS8151 - COMMUNICATIVE ENGLISH',
        units:[
          ...
          },
          {
            ...
            content: 'Reading- short texts and longer passages (close reading) Writing- understanding text structureuse of reference words and discourse markers-coherence-jumbled sentences Listening – listening to longer texts and filling up the table- product description- narratives from different sources. Speaking- asking about routine actions and expressing opinions. Language development- degrees of comparison- pronouns- direct vs indirect questions- Vocabulary development – single word substitutes- adverbs.'
          },
          {
            chapterName: 'Unit 4 - READING AND LANGUAGE DEVELOPMENT',
            content: 'Reading- comprehension-reading longer texts- reading different types of texts- magazines Writing- letter writing, informal or personal letters-e-mails-conventions of personal emailListening- listening to dialogues or conversations and completing exercises based on them. Speaking- speaking about oneself- speaking about one‘s friend- Language developmentTenses- simple present-simple past- present continuous and past continuous- Vocabulary development- synonyms--antonyms- phrasal verbs.'
          },
          {
  ...
  return (
    <div className="min-h-screen pt-12 m-auto w-[90%]">
        <h1 className="text-xl font-semibold flex justify-center">ECE Sem - 1</h1>
        <Accordions data={data} />
    </div>
  )
}

export default Sem1Ece