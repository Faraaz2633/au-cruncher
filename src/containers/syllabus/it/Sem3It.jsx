  ...
  const data = [
    {
      ...
      {
        subjectName: 'EC8394-Analog and Digital Communication – ADC',
          units:[
            {
              chapterName: 'Unit 1 -',
              content: ''
          ...
          subjectName: 'CS8351 – Digital Principles and System Design',
            ...
            subjectName: 'CS8391 – Data Structures',
              units:[
                ...
                {
                  chapterName: 'Unit 5 - Definition — Representation of Graph — Types of graph — Breadth-first traversal — Depth-first traversal — Topological Sort — Bi-connectivity — Cut vertex — Euler circuits — Applications of graphs.',
