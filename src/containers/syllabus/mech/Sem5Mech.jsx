...
const Sem5MECH = () => {
  const data = [
    {
      ...
      units: [
        ...
        },
        {
          ...
          content:
            "Listening- TED/Ink talks; Speaking –participating in a group discussion -Reading– reading and understanding technical articles Writing– Writing reports- minutes of a meeting- accident and surveyVocabulary Development- verbal analogies Language Development- reported speech.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      units: [
        ...
        {
          chapterName: "Unit 3 - NEW MATERIALS",
          content:
        ...
        {
          chapterName: "Unit 5 - MECHANICAL PROPERTIES",
          content:
    ...
    },
    {
      ...
      units: [
        ...
        },
        {
          ...
          content:
            "Principles of operation and characteristics of ; DC machines, Transformers (single and three phase ) ,Synchronous machines , three phase and single phase induction motorsPrinciples of operation and characteristics of ; DC machines, Transformers (single and three phase ) ,Synchronous machines , three phase and single phase induction motors.",
        },
        {
        ...
        {
          chapterName: "MEASUREMENTS & INSTRUMENTATION",
          content:
    ...
    },
    {
      ...
      units: [
        ...
        },
        {
          ...
          content:
            "Laws of sliding friction – equilibrium analysis of simple systems with sliding friction – wedge friction-. Rolling resistance -Translation and Rotation of Rigid Bodies – Velocity and acceleration – General Plane motion of simple rigid bodies such as cylinder, disc/wheel and sphere.",
        },
      ],
    },
  ];
  return (
    <div className="min-h-screen pt-12 m-auto w-[90%]">
      <h1 className="text-xl font-semibold flex justify-center">MECH Sem - 5</h1>
      <Accordions data={data} />
    </div>
  );
};

export default Sem5MECH;
